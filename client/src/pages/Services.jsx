  ...
  const services = [
    {
      ...
      description:
        "Report potholes, damaged roads and traffic issues.",
...

    {
      ...
      title: "Water Supply",
      description:
        "Report water leakage and drainage problems.",
...

    {
      ...
      title: "Street Lights",
      description:
        "Report damaged street lights and power issues.",
          ...
          <div className="row g-4">
            ...
            {services.map((service) => (
              ...
              <div className="col-md-4" key={service.id}>
                ...
                <div className="service-box" onClick={() => toggleCard(service.id)}>
